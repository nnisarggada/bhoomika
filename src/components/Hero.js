  ...
  return (
    ...
    >
      <div className="flex flex-col h-full gap-10 justify-end items-center lg:items-start lg:justify-center">
        <h1 className="text-4xl font-bold text-center text-secondary lg:text-8xl lg:text-left">
          The Journey Within
        </h1>
        <h3 className="text-xl text-center text-secondary lg:text-2xl lg:text-left lg:w-2/3">
        ...
        <button
          ...
          className="text-xl text-center text-text bg-primary drop-shadow-2xl w-60 h-16 rounded-lg hover:-translate-y-2 hover:transition-all hover:duration-300 hover:ease-in-out lg:text-3xl lg:w-80"
        >
          Watch Trailer
        </button>
      </div>
